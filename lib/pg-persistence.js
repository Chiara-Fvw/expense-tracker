...
module.exports = class PgPersistence {
  ...
  //Order expenses
  async orderExpensesBy(id, column) {
    const ORDERED_EXPENSES = "SELECT * FROM expenses WHERE category_id = $1 ORDER BY $2 ASC";

    let result = await dbQuery(ORDERED_EXPENSES, id, column);
    return result.rows;
  }
};